...
(function(mod) {
            ...
            if (cmp(newPos, curPos) == 0) {
              ...
              if (!newPos) {
                if (flipped) {
                  ...
                  // -- try again *withclearing, if we didn't already
  ...
  function registerEventHandlers(cm) {
    ...
    // Some browsers fire contextmenu *afteropening the menu, at
  ...
  var dragAndDrop = function() {
    // There is *somekind of drag-and-drop support in IE6-8, but I
